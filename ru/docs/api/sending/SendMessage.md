...
----- | ----- | ----- | -----
`chatId` | **string** | Да | Идентификатор личного чата в формате `00000000000@c.us` или идентификатор группового чата в формате `00000000000-XXXXXXXXXX@g.us`; Пример: `79001234567@c.us` или `79001234567-1581234048@g.us` Перед отправкой сообщения в личный или групповой чат получите [Идентификатор чата](/api/chat-id)
