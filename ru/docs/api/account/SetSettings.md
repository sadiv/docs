...
`sharedSession` | **string** | Установить настройку режима разделяемой сессии. При включенной настройке sharedSession аккаунт не будет пытаться принудительно  присоединиться к телефону. Следует включать настройку, если требуется работать на одном телефоне как с мессенджером вручную, так и через апи.
