...
- [Нажатие пользователя на обычную кнопку](./receiving/notifications-format/selected-buttons/ButtonsResponseMessage.md)
- [Нажатие пользователя на шаблонную кнопку](./receiving/notifications-format/selected-buttons/TemplateButtonsReplyMessage.md)
- [Нажатие пользователя на значение списка выбора](./receiving/notifications-format/selected-buttons/ListResponseMessage.md)
