...
В данном разделе представлены методы для получения входящих данных: сообщений, файлов, статусов отправленных сообщений, статуса аккаунта и устройства (телефона)
